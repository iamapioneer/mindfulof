<?php
	...
	**/
	...
	function display_latest_tweets(
		...
		$tweets_to_display   = 4,               // Number of tweets you would like to display. (Default : 5)
		...
		$tweet_wrap_open     = '<div class="tweet-container square"><p class="tweet">',
		$meta_wrap_open      = '<br/><span class="tweet-date">',
		...
		$consumerkey         = "AzAYq0DZPBUKQyPMqZitJv8oM";
		$consumersecret      = "G4RMmKmQDD1uP1pPgmvuXDQR5231TdOiEdYjMySK3qtCWhrFNV";
		$accesstoken         = "262510133-G0ivxsK6bs3Ii8QkjTPqSDU44dRbf5fmaB2SsjkH";
		$accesstokensecret   = "g3Dzo2s2chy7R8vCtPqjtSi3Y7XU8lcQx7z1lVnEvwyF4";
	...
	display_latest_tweets('iamMindfulOf');
?>
